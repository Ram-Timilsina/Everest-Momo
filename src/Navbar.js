...
const Navbar=()=>{
    return(
        ...
        <div className="nav">
            <div className='first'>
                <Link className='navlink-style' to="/home"><img src={logo} alt='logo' /></Link>
            </div>
            <ul className='second'>
            ...
            <li>
            <Link className="navlink-style" to="/services">Our Services</Link>
            </li>        
            <li>
            <Link className="navlink-style" to="/Allergy">Allergy Advice</Link>
            </li>
            </ul>
            <div className='icon1'>
            ...
            <div className='btn'>
            <li><a href="/contact"><button className='BTN1'>Contact Us</button></a></li>
